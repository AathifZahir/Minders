...
<div align="center">
    <img src="gitimg/1.png" alt="Image Description" style="width: 32%; border-radius: 50%; margin: 10px; display: inline-block;"/>
    <img src="gitimg/2.png" alt="Image Description" style="width: 32%; border-radius: 50%; margin: 10px; display: inline-block;"/>
    <img src="gitimg/3.png" alt="Image Description" style="width: 32%; border-radius: 50%; margin: 10px; display: inline-block;"/>
</div>
